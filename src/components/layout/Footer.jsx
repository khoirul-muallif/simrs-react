  ...
  return (
    <footer className="bg-blue-900 text-white mt-20">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-blue-300 text-xs">Melayani Dengan Sepenuh Hati</p>
            </div>
          </div>
          ...
          <div className="flex gap-4 mt-2">
            <a href="#" className="text-blue-300 hover:text-white text-xl transition">
              <FaFacebook />
            </a>
            <a href="#" className="text-blue-300 hover:text-white text-xl transition">
              <FaInstagram />
        ...
        {/* Kolom 2 - Link Cepat */}
        <div>
          <h4 className="font-bold text-lg mb-4 border-b border-blue-700 pb-2">
            Link Cepat
          </h4>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 text-sm text-blue-200">
            <li className="flex items-start gap-2">
              <FaClock className="mt-1 text-blue-300 shrink-0" />
              <div>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 text-sm text-blue-200">
            <li className="flex items-start gap-2">
              <FaMapMarkerAlt className="mt-1 text-blue-300 shrink-0" />
